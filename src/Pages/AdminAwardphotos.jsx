...
import './AdminAwardphotos.css';

const AdminAwardphotos = () => {
  ...
  return (
    <div className="admin-achievement-container">
      ...
      <header className="admin-header">
        ...
        <h2>Admin: Manage Award Photos</h2>
      </header>

      <h3>Manage Award Photos Details</h3>
      ...
      {achievements.map((achievement, index) => (
        <div key={achievement.id} className="achievement-box">
          ...
          <div className="cover-image-section">
            <h4>Award Photos {index + 1} - Cover Image</h4>
          ...
          <div className="title-section">
            <h4>Award Photos Image {index + 1} - Title</h4>
            <input
              type="text"
          ...
          <div className="details-section">
            <h4>Award Photos Image Details</h4>
            <textarea
...
export default AdminAwardphotos;
